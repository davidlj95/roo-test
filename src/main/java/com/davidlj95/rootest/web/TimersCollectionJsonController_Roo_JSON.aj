...
import com.davidlj95.rootest.web.TimersCollectionJsonController;
import com.davidlj95.rootest.web.TimersItemJsonController;
...
privileged aspect TimersCollectionJsonController_Roo_JSON {
    ...
    declare @type: TimersCollectionJsonController: @RequestMapping(value = "/timers", name = "TimersCollectionJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
